...
"IT412-Professional-Training-in-Software-Testing-3"
    ...
    for (int i = 0; i < 50; i++) {
        ...
        fprintf(file, "221008802,Abdelrahman Mohammed Hussain,89,Passed\n");
        fprintf(file, "221008720,Zeyad hamdy Abdo Hussien,90,Passed\n");
        fprintf(file, "221018151,Mohamed Elhussein Mohamed Gad,75,Passed\n");
        fprintf(file, "221008756,Kareem Mohamed Youssef Ahmed,91,Passed\n");
        fprintf(file, "221008565,Martin Maged Fouad Gerges,97,Passed\n");
